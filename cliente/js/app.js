...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('/cliente/js/service-worker.js')
      .then(registration => {
...
// NOTA: Notificaciones manejadas por backend MySQL - Deshabilitado por ahora
async function setupPushNotifications() {
  console.log('ℹ️  Notificaciones push deshabilitadas - Se manejan desde el servidor MySQL');
  return;
  /*
